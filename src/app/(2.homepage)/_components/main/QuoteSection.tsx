...
export default function QuoteSection() {
  ...
  return (
    <section className="bg-stone-100 py-20 text-center md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div
          ref={imageRef}
          className={`mb-8 flex justify-center transition-transform duration-1000 md:mb-16 ${
            isVisible ? "rotate-0" : "rotate-54"
          }`}
        >
          <Image
            src="/images/index/ruota_wheel.webp"
            alt="굴러가는 바퀴 속 기울어진 잔"
            width={150}
            height={150}
            className="md:h-[200px] md:w-[200px]"
          />
        </div>
        <h2 className="mb-8 text-4xl font-bold text-stone-800 md:mb-16 md:text-5xl">
          " The tilted cup will make your feeling better. "
        </h2>
        <p className="mb-4 text-sm text-stone-600 md:mb-6 md:text-lg">
        ...
        <p className="mb-8 text-sm text-stone-600 md:mb-12 md:text-lg">
          일상 속 커피 한 잔으로
          <br />
