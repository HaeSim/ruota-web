  ...
  return (
    <PageContainer>
      <div className="h-full w-full">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">배너 수정</h1>
          <p className="text-muted-foreground">배너 ID: {id}의 정보를 수정합니다.</p>
        </div>
        <BannerForm initialData={bannerData} mode="edit" />
      </div>
    </PageContainer>
  )
}
